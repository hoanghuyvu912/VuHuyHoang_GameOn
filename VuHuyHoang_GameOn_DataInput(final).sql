...
insert into game_comment(id, user_id, game_id, comment_content)
values(1, 1, 1, 'Game is good.'),
(2, 1, 2, 'Game is great'),
(3, 1, 3, 'Game is awesome!'),
(4, 2, 4, 'Game sucks!'),
(5, 1, 21, 'What a Dark Souls rip-off!'),
(6, 2, 10, 'Game is hard!'),
(7, 2, 14, 'Assassin''s Creed has lost its way'),
(8, 2, 3, 'Good port from the PS4.'),
(9, 2, 41, 'PRAISE THE SUN!'),
(10, 3, 23, 'I play this game for the plot.'),
(11, 3, 20, 'The last great game from EA.'),
(12, 3, 9, 'What is this, 2D Dark Souls??!'),
(13, 3, 26, 'John Wick if he had a cyber arm.'),
(14, 4, 28, 'Look ma I''m robbing a bank!'),
(15, 4, 1, 'The best focking game I''ve ever played!'),
(16, 4, 5, 'Why does this guy look like every Spider-Man actor combine?'),
(17, 4, 3, 'I got to fight giant mechanical dinosaurs, 10/10.' ),
(18, 5, 4, 'The worst port Naughty Dog has ever made!'),
(19, 5, 2, 'BOIIIIIIIIIIIIIIIIIIIIIIII'),
(20, 5, 39, 'I bought this just to see Aerith got donut in 4k.'),
(21, 5, 7, 'I FEEL MOTIVATED'),
(22, 5, 46, 'LEON YOU MUST CONTINUE THE REDFIELD BLOODLINE!'),
(23, 6, 8, 'CHOKE ME HARDER MAMA DIMITRESCU!'),
(24, 6, 11, 'Barb wire baseball bat go brrrrrr'),
(25, 6, 33, 'GOMU GOMU NO EAT SH*T **********'),
(26, 6, 29, 'I came here to play video game, not to feel depressed wtf Rockstar??!'),
(27, 7, 3, 'Aloy''s dad literally went out to buy milk and never came back.'),
(28, 7, 21, 'PARRY THIS YOU F**KING CASUAL!'),
(29, 7, 13, 'Buy the game expecting to watch dogs. No dog in the game, 0/10.'),
(30, 7, 22, 'Dong Zhou literally got NTR by his adopted son.'),
(31, 7, 32, 'I smash random buttons with Eddy Gordo and win. Definitely would Eddy Gordo again.'),
(32, 8, 25, 'TEAM TRISS FTW!'),
(33, 8, 37, 'Who let the onion-cutting ninjas in??!'),
(34, 8, 27, 'There''s a kingdom need saving and here I am playing Gwent with Ciri.'),
(35, 8, 30, 'SLOW MO BULLETS GO BRRRRRRRRRRRR'),
(36, 9, 2, 'Dont be sorry, be better boi.'),
(37, 9, 1, 'Nathan please give me your seed.'),
(38, 9, 23, 'A Dead or Alive game without fighting, weird.'),
(39, 10, 35, 'ChatGPT if they went sentient.'),
(40, 10, 36, 'Ooooooo scary.'),
(41, 10, 16, 'Typically American dream.'),
(42, 11, 41, '^#$%#$%%$&%^*%^&%^&(**!#$#'),
(43, 11, 31, 'Ivy can penetrate me with her sword anytime.'),
(44, 11, 40, 'Somehow a 2D game is better than all these 3D AAA games.'),
(45, 12, 14, 'How is a Viking also an assassin??!'),
(46, 12, 4, 'The last of us? More the like the last of my pc after it finishes compiling these textures.'),
(47, 12, 17, 'Stop feeding us the same game every year EA.'),
(48, 13, 34, 'Unexpected good game.'),
(49, 13, 39, 'Sephiroth looks like he can be my sugar daddy.'),
(50, 13, 25, 'TEAM YENNEFER!'),
(51, 14, 19, 'My name is commander Shepard, and this is my favorite store on the Citadel.'),
(52, 14, 18, 'Changing pants simulator.'),
(53, 14, 9, 'Easy game.'),
(54, 15, 46, 'Ashley is no longer useless.'),
(55, 15, 25, 'The jiggling physics in this game is weird.'),
(56, 15, 10, 'A gun in ancient history time? Count me in.'),
(57, 15, 30, 'Max no longer has hair, 0 hair/10.'),
(58, 16, 34, 'Like.'),
(59, 16, 6, 'No uncle Ben, no aunt May, just Miles being a chad.'),
(60, 16, 20, 'RESPAWN MAKE TITAN FALL 3 PLEASE!!!!!'),
(61, 16, 35, 'This game gave me anxiety, now I''m afraid im gonna make Alexa mad and at night she will choke me to death with a pillow.'),
(62, 17, 46, 'SUPLEX CITY'),
(63, 17, 8, 'If i got put into a castle with a THICC AF mama and her 3 vampire daughters, i wouldn''t complain.'),
(64, 17, 18, 'Isaac Clarke looks like Adam Sandler now and I''m not okay with it.'),
(65, 18, 22, 'Loudsy PC port, poor customization.'),
(66, 18, 36, 'I have to consult a therapist after finishing this game.'),
(67, 18, 7, 'Vergil best dad.'),
(68, 19, 26, 'BRING BACK JACKIE RIGHT NOW'),
(69, 19, 8, 'I must go to the gym at this very moment to look like Chris Redfield.'),
(70, 19, 38, 'Weeb game'),
(80, 20, 28, 'Trevor looks like my long lost father.'),
(81, 20, 9, 'Go back to 2D Mega Man please.'),
(82, 20, 45, 'Game nhái phi phai.'),
(83, 21, 44, 'Spider-Man on crack.'),
(84, 22, 17, 'Better than PES.'),
(85, 22, 29, 'PC gaming at its peak.'),
(86, 22, 42, 'If you kill the turtle pope you''re a terrible person.'),
(87, 22, 21, 'Why does the bad guy keep licking himself'),
(88, 23, 7, 'Why does Dante keep looking better the more he age'),
(89, 23, 31, 'Vordo is a creep.'),
(90, 23, 33, 'Zorro got lost again.'),
(91, 23, 15, 'No nuke, 0/10.'),
(92, 24, 1, 'Please don''t reboot the Uncharted series.'),
(93, 24, 4, 'Technical issues make this game completely unplayble.'),
(94, 24, 14, 'Hey at least we can cosplay Thor by wielding his hammer.'),
(95, 18, 13, 'HACKERMAN'),
(96, 19, 46, 'Press X to struggle.'),
(97, 21, 39, 'Cloud in a dress is my wet dream.'),
(98, 21, 16, 'How can a guy have too many nukes and the US government still lets him live??!');
